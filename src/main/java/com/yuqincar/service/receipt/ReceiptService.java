...
public interface ReceiptService {
	 ...
	 * @return 
	 */
	List<OrderStatement> getAllOrderStatement();
	 ...
	 */
	void save(OrderStatement orderStatement);
	 ...
	 * @param ids
	 */
	void excludeOrdersFromOrderStatement(String orderStatementName, Long[] ids);
