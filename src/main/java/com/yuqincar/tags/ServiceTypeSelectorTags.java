...
public class ServiceTypeSelectorTags extends TagSupport {
	...
	public int doStartTag() throws JspException {
		...
		try {
			String labelValue = (serviceType == null ? "" : serviceType
					.getTitle());
			String idValue = (serviceType == null ? "" : String
					.valueOf(serviceType.getId()));
			options.append("<input id="
					+ name
					+ "Label name="
					+ name
					+ "Label class=\"inputText\" type=\"text\" onclick=\"onServiceTypeSelectorClick(\'"
