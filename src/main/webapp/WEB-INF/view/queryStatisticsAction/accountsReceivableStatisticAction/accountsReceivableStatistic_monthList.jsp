...
<body class="minW">
	<div class="space">
		...
		<div class="tab_next style2">
				        <table>
				            <tr>
				                <td><s:a action="accountsReceivableStatistic_list"><span>今日统计</span></s:a></td>
				                <td><s:a action="accountsReceivableStatistic_weekList"><span>本周统计</span></s:a></td>
				                <td class="on"><s:a action="accountsReceivableStatistic_monthList"><span>本月统计</span></s:a></td>
				                <td><s:a action="accountsReceivableStatistic_query"><span>查询</span></s:a></td>
				            </tr>
				        </table>
				    </div>
		<div class="editBlock search">
			<s:form id="pageForm" action="accountsReceivableStatistic_monthList">
			<table>
	...
	<div style="text-align:center;">
		...
		<th></th>
		<td>
			<img width="900" height="600" src="accountsReceivableStatistic_MoMHistogram.action?dateString=${dateString}"/>		
		</td>
		</tr>
	</div>
	<div style="text-align:center; margin-top:50px">
		...
		<th></th>
		<td>
			<img width="900" height="600" src="accountsReceivableStatistic_YoYHistogram.action?dateString=${dateString}"/>		
		</td>
		</tr>
	</div>
	</s:if>
