...
<body class="minW">
		...
		<div class="tab_next style2">
				        <table>
				            <tr>
				                ...
				                <td class="on"><s:a action="completedOrderStatistic_monthList"><span>本月统计</span></s:a></td>
				                <td><s:a action="completedOrderStatistic_query"><span>查询</span></s:a></td>
				            </tr>
				        </table>
				    </div>
		<div class="editBlock search">
			<s:form id="pageForm" action="completedOrderStatistic_monthList">
			<table>
				<tr style="height:10px;">
					...
					<td id="todayStatistic" class="inputButton"><span>今日统计</span></td>
				    <td id="weekStatistic" class="inputButton"><span>本周统计</span></td>
				    <td id="monthStatistic" class="inputButton"><span>本月统计</span></td>
				    <td id="query" class="inputButton"><span>查询</span></td>
				    -->
				</tr>
				<tr>
					<th>选择日期:</th>
	...
	<div style="text-align:center;">
		<tr id="showHistogram" style="display:none">
		<th></th>
		<td>
			<img width="900" height="600" src="completedOrderStatistic_showHistogram.action"/>		
		</td>
		</tr>
	</div>
