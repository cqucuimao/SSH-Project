...
<cqu:border>
    <div class="space">
        ...
        <div class="editBlock detail p30">
        	<s:form action="order_cancelDo" id="myForm">
            ...
            <table>
                <tbody>
                    ...
                    <tr>
                        <th>取消原因：<span class="required">*</span></th>
                        <td>
							<s:textarea style="height:100px;" class="w" name="cancelReason" placeholder="请输入取消原因"/>
						</td>
                        <th></th>
                        <td></td>
                    </tr>
                ...
                <tfoot>                    
                    ...
                    <tr>
                        <td colspan="4">
                        	<s:submit value="确定取消" class="inputButton coverOff"></s:submit>
