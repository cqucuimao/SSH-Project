...
<body class="minW">
    <div class="space">
        ...
        <div class="editBlock detail p30">
        	<s:form action="order_modifyMoneyDo" id="myForm">
            ...
            <table>
                <tbody>
                    ...
                    <tr>
                        ...
                        <th>订单金额：<span class="required">*</span></th>
                        <td>
							<s:textfield name="orderMoneyString" type="text" class="inputText" style="width: 60px;"/>&nbsp;元
						</td>
                    </tr>
                    <tr>
                        <th>备注：</th>
