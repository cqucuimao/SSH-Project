...
(function() {
     ...
     */
     BMapLib.LuShu = function(map, path,speedPoints, opts) {
        ...
        if (me.i && me.i < len) {
            ...
            me._timeoutFlag = setTimeout(function() {
                    ...
                    //if(me._opts.defaultContent == ""){             
						...
						//******个人修改********
						// me.hideInfoWindow();
                        me._opts.defaultContent =me._speedPoints[me.i] +"公里/小时";
                        
                       /* console.log("传进lushu中的速度");
                        console.log(me._speedPoints);
                        console.log(me._speedPoints[me.i]);*/
     ...
     * @return 无返回值
     */
    LuShu.prototype.speedUp = function() {
        this._opts.speed = this._opts.speed*2;
		this._opts.defaultContent =this._opts.speed/1000 +"公里/小时";
    };
     ...
     * @return 无返回值
     */
    LuShu.prototype.speedDown = function() {
        this._opts.speed = this._opts.speed/2;
		this._opts.defaultContent =this._opts.speed/1000 +"公里/小时";
    };
    
    /**
	 * 自定义函数 setMoveIndex 重新设置移动位置
     * @return 无返回值
     */
    LuShu.prototype.moveNextPoint = function(index) {
    	this.i=index;
		console.log(this.i);
    ...
    baidu.object.extend(LuShu.prototype, {
        ...
        _move: function(initPos,targetPos,effect) {
            ...
            currentCount = 0,
            //步长，米/秒
           // timer = 200,   //这个应该是动画效果的刷新时间，与前台系统保持一致
          //  step=0,        //为了满足播放条的需求 解决回转问题
            //step = this._opts.speed / (1000 / timer),
            //初始坐标
            init_pos = this._projection.lngLatToPoint(initPos);
        	console.log("me.i="+me.i);
        	console.log(me.i);
        	console.log("me._path.length="+me._path.length);
			if(me.i>=me._path.length-1)
			{
				targetPos=initPos;
				console.log("执行targetPos重新赋值了");
			}
            //获取结束点的(x,y)坐标
           ...
           //count = Math.round(me._getDistance(init_pos, target_pos) / step);
            var count=1;          //需求要求按点走，所以将步长设置为1，即两点之间只需要1步
   ...
   // }
	...
	console.log("设置位置有没有执行呢1");
	console.log("设置位置有没有执行呢2");
    //设置自定义overlay的位置
    me._setInfoWin(pos);
    //********自定义添加 是每次移动速度得到更新*********
    me._opts.defaultContent =me._speedPoints[me.i] +"公里/小时";
        ...
        //两点之间当前帧数大于总帧数的时候，则说明已经完成移动
            if (currentCount >= count) {
                ...
                me._moveNext(++me.i);
                    ...
                    me._setInfoWin(pos);
                    //********自定义添加 是每次移动速度得到更新*********
                    me._opts.defaultContent =me._speedPoints[me.i] +"公里/秒";
                }
        },timer);*/
    },
    /**
    ...
    */
    setRotation : function(prePos,curPos,targetPos){
        ...
        _moveNext: function(index) {
        	var me = this;
			console.log("当前lushu中的索引  "+index+" 序列长度 "+this._path.length);
